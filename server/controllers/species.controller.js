...
;
    ...
    const residencyOptions = ['Altitudinal Migrant', 'Resident', 'Passage Migrant', 'Summer Visitor', 'Introduced', 'Vagrant', 'Winter Visitor', 'No recent records', 'Visitor', 'Rare Visitor']
